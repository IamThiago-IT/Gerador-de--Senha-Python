...
function UI() {
    ...
    UI.prototype.addQuestion = function (element, question) {
      ...
      <a href="#" class="text-capitalize my-3 show-answer">Mostrar/Esconder conteudo</a>
      <h5 class="answer mb-3">${question.answer}</h5>
      <div class="flashcard-btn d-flex justify-content-between">
 
       <a href="#" id="edit-flashcard" class=" btn my-1 edit-flashcard text-uppercase" data-id="${question.id}">Editar</a>
       <a href="#" id="delete-flashcard" class=" btn my-1 delete-flashcard text-uppercase" data-id="${question.id}">Deletar</a>
      </div>
     </div>`;
